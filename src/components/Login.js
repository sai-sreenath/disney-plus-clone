...
const Container = styled.section`  //This is section, whole page
    overflow:hidden;
    display:flex;
...
const Content = styled.div`  //This is div just the center (GET THE DISNEY BUNDLE)
    margin-bottom: 10vw;
    width : 100%;
    position : relative;
    min-height : 100vh;
...
const BgImage = styled.div`
    ...
    right: 0;
    left: 0;
    z-index: -1 //making it low priority one
`;
